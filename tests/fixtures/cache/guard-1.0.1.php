 ...
 * Description: Password cache exclusions and cacheable form-page identification for One Nation and Josh only.
 * Version: 1.0.1
 */
...
final class Acquire_Public_Cache_Guard {
    ...
    public static function enabled() {
        $sites = array(5 => 'onenationamerica.org', 7 => 'meetjoshturek.com');
