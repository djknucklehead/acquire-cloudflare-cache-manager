<?php
/**
 * Plugin Name: Acquire Public Cache Guard
 * Description: Password cache exclusions and cacheable form-page identification for approved SLF public domains.
 * Version: 1.0.3
 */
defined('ABSPATH') || exit;

final class Acquire_Public_Cache_Guard {
    private static $reason = '';
    private static $form_present = false;

    public static function enabled() {
        $sites = array(5 => 'onenationamerica.org', 7 => 'meetjoshturek.com', 15 => 'peachstatepost.com', 16 => '40yearsisenough.com', 18 => 'meettroyjackson.com', 19 => 'elsayedmi.com', 21 => 'meetmarypeltola.com');
        $id = get_current_blog_id();
        return isset($sites[$id]) && wp_parse_url(home_url('/'), PHP_URL_HOST) === $sites[$id];
    }
...
add_action('template_redirect', array('Acquire_Public_Cache_Guard','prepare'), -9999);
add_filter('gform_pre_render', array('Acquire_Public_Cache_Guard','form'), -9999, 4);
