...
4. Create a GitHub Release with a tag such as `v3.2.1`.
...
4. On GitHub.com, create a new release using a tag like `v3.2.1`.
5. Publish the release without manually attaching a zip.
6. GitHub Actions will build `acquire-cloudflare-cache-manager-v3.2.1.zip` and attach it to the release automatically.
